...
import "cpp_language_installer.dart";
...
class CPPLanguage extends Language {
  ...
  @override
  final String languageId = 'cpp';

  @override
  final String displayName = 'C++';

  @override
  List<String> get extensions => const ['cpp', 'hpp', 'cc', 'hh'];

  @override
  LanguageInstaller? get installer => CPPLanguageInstaller();
  ...
  Widget get icon => Image.asset(
    "assets/language_icons/lang_cpp.png",
    width: 24,
    height: 24,
    fit: BoxFit.contain,
  );
