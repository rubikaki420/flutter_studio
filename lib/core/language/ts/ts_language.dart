...
import 'ts_language_installer.dart';

class TsLanguage extends Language {
  ...
  @override
  final String languageId = 'typescript';

  @override
  final String displayName = 'TypeScript';

  @override
  List<String> get extensions => const ['ts', 'tsx'];

  @override
  LanguageInstaller? get installer => TsLanguageInstaller();
  ...
  Widget get icon => Image.asset(
    "assets/language_icons/lang_typescript.png",
    width: 24,
    height: 24,
  );

  @override
  Mode? get mode => langTypescript;
