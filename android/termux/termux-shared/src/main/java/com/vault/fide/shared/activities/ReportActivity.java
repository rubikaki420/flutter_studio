package com.vault.fide.shared.activities;
...
import com.vault.fide.shared.file.filesystem.FileType;
 ...
 * {@code `<activity android:name="com.vault.fide.shared.activities.ReportActivity" android:theme="@style/Theme.AppCompat.TermuxReportActivity" android:documentLaunchMode="intoExisting" />` }
 * and
 * {@code `<receiver android:name="com.vault.fide.shared.activities.ReportActivity$ReportActivityBroadcastReceiver"  android:exported="false" />` }
