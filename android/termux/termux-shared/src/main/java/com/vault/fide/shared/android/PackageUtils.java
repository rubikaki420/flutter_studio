package com.vault.fide.shared.android;
...
public class PackageUtils {
    ...
    public static String getSigningCertificateSHA256DigestForPackage(@NonNull final Context context, @NonNull final String packageName) {
        try {
             ...
             * W/PackageManager: Failed to parse /path/to/com.vault.fide.tasker.apk: Signature mismatch for shared user: SharedUserSetting{xxxxxxx com.vault.fide/10xxx}
             */
