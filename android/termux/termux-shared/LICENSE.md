...
- [`src/main/java/com/vault/fide/shared/termux/*`](src/main/java/com/vault/fide/shared/termux).

The `GPLv3 only` license applies to all files unless specifically specified by a file/directory, like the [`src/main/java/com/vault/fide/shared/termux/TermuxConstants.java`](src/main/java/com/vault/fide/shared/termux/TermuxConstants.java) and [`src/main/java/com/vault/fide/shared/termux/settings/properties/TermuxPropertyConstants.java`](src/main/java/com/vault/fide/shared/termux/settings/properties/TermuxPropertyConstants.java) files are released under the `MIT` license.
##
