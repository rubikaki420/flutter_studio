...
import com.vault.fide.shared.termux.terminal.io.BellHandler;
import com.vault.fide.shared.logger.Logger;
import com.vault.fide.terminal.TerminalColors;
import com.vault.fide.terminal.TerminalSession;
import com.vault.fide.terminal.TerminalSessionClient;
import com.vault.fide.terminal.TextStyle;
...
public class TermuxTerminalSessionActivityClient extends TermuxTerminalSessionClientBase {
    ...
    private synchronized void loadBellSoundPool() {
        if (mBellSoundPool == null) {
            ...
            try {
                mBellSoundId = mBellSoundPool.load(mActivity, com.vault.fide.shared.R.raw.bell, 1);
            } catch (Exception e){
                // Catch java.lang.RuntimeException: Unable to resume activity {com.vault.fide/com.vault.fide.app.TermuxActivity}: android.content.res.Resources$NotFoundException: File res/raw/bell.ogg from drawable resource ID
